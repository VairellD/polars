...
@section('content')
    <div class="container py-4">
        <div class="row">
            ...
            <div id="Leftcard" class="col-lg-3 d-none d-lg-block ">
                            ...
                            <form action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data"
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <div class="form-control border-0 mb-2 post-input" contenteditable="true"
                                        ...
                                        <div id="media-type-badges" class="mb-2" style="display: none;">
                                            <div class="d-flex flex-wrap gap-1">
                                                <span id="badge-image" class="badge bg-primary rounded-pill"
                                                    style="display: none;">
                                                    <i class="bi bi-image"></i> <span id="image-count">0</span> Images
                                                </span>
                                                <span id="badge-video" class="badge bg-danger rounded-pill"
                                                    style="display: none;">
                                                    <i class="bi bi-camera-video"></i> <span id="video-count">0</span> Videos
                                                </span>
                                                <span id="badge-audio" class="badge bg-success rounded-pill"
                                                    style="display: none;">
                                                    <i class="bi bi-music-note-beamed"></i> <span id="audio-count">0</span>
                                                    Audio
                                                </span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown">
                                                    <button type="button"
                                                        class="btn btn-sm text-primary border-0 dropdown-toggle"
                                                    ...
                                                    <ul class="dropdown-menu category-dropdown"
                                                        ...
                                                        <li><a class="dropdown-item category-option" href="#"
                                                                data-category="Tugas Akhir" data-icon="🎓">🎓 Tugas Akhir</a>
                                                        </li>
                                                        <li><a class="dropdown-item category-option" href="#"
                                                                data-category="Audio" data-icon="🎵">🎵 Audio</a></li>
                                                        <li><a class="dropdown-item category-option" href="#"
                                                                data-category="Video" data-icon="🎬">🎬 Video</a></li>
                                                        <li><a class="dropdown-item category-option" href="#"
                                                                data-category="Foto" data-icon="📸">📸 Foto</a></li>
                                                        <li><a class="dropdown-item category-option" href="#"
                                                                data-category="Animasi" data-icon="🎭">🎭 Animasi</a></li>
                                                        <li><a class="dropdown-item category-option" href="#"
                                                                data-category="UI/UX" data-icon="🎨">🎨 UI/UX</a></li>
                                                        <li><a class="dropdown-item category-option" href="#"
                                                ...
                                                <input type="file" name="files[]" class="d-none" id="file-upload-image"
                                                    accept="image/*" multiple>
                                                <input type="file" name="files[]" class="d-none" id="file-upload-video"
                                                    accept="video/*" multiple>
                                                <input type="file" name="files[]" class="d-none" id="file-upload-audio"
                        ...
                        <div class="card-body p-3">
                            <div class="d-flex">
                                <div class="rounded-circle overflow-hidden me-2"
                                    ...
                                    <img src="{{ $post->user->profile_picture ?? asset('assets/default-avatar.png') }}"
                                ...
                                <div class="w-100">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                <li><a class="dropdown-item" href="{{ route('posts.show', $post) }}">View
                                                        post</a></li>
                                    ...
                                    @if($post->hashtags && $post->hashtags->count() > 0)
                                        <div class="mb-2">
                                            @foreach($post->hashtags as $hashtag)
                                                {{-- <a href="{{ route('posts.hashtag', $hashtag->slug) }}"
                                                    class="hashtag-display me-1 text-decoration-none">#{{ $hashtag->name }}</a> --}}
                                    ...
                                    @if($post->category)
                                        <div class="mb-2">
                                            <a href="{{ route('posts.category', $post->category->slug) }}"
                                                class="category-display me-1 text-decoration-none">
                                                <span class="bi {{$post->category->icon}}"></span> {{ $post->category->name }}
                                            </a>
                                        </div>
                                    @endif
                                                        ...
                                                        @elseif($media->file_type == 'video')
                                                            <video autoplay muted loop playsinline>
                                                                <source src="{{ $media->file_url }}"
                                                                    type="video/{{ $media->file_extension }}">
                                                        ...
                                                        @elseif($media->file_type == 'audio')
                                                            <div class="soundcloud-player">
                                                                <div class="soundcloud-header d-flex align-items-center mb-2">
                                                                    ...
                                                                    <div class="audio-info ms-2">
                                                                        <div class="audio-title">
                                                                            {{ pathinfo($media->file_url, PATHINFO_FILENAME) }}
                                                                        </div>
                                                                ...
                                                                <audio class="d-none audio-element" data-media-id="{{ $media->id }}">
                                                                    <source src="{{ $media->file_url }}"
                                                                        type="audio/{{ $media->file_extension }}">
                                                                </audio>
                                                            </div>
                                                        @endif
                                    ...
                                    <div class="d-flex mt-2">
                                        <button class="btn btn-sm btn-link text-muted me-3 like-button"
                                            ...
                                            <i
                                                class="bi {{ $post->isLikedBy(Auth::user() ?? null) ? 'bi-heart-fill text-danger' : 'bi-heart' }}"></i>
