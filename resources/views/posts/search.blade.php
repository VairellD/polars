        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-8">
                ...
                @if($users->count() > 0)
                    <div class="card border-0 shadow-sm rounded-lg mb-4">
                        <div class="card-body p-3">
                            <h6 class="mb-3 fw-bold">People matching "{{ request('search') }}"</h6>
                            @foreach ($users as $user)
                                <div class="d-flex align-items-center mb-3">
                                    <div class="rounded-circle overflow-hidden me-2" style="width: 40px; height: 40px;">
                                        <img src="{{ $user->profile_picture ?? asset('assets/default-avatar.png') }}"
                                    ...
                                    <a href="{{ route('profile.show', $user->id) }}" class="ms-2">
                ...
                @if(request('search'))
                    <h5 class="mb-3">Search results for: "{{ request('search') }}"</h5>
                @endif
